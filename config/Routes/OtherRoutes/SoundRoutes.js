...
const Update = require('../../Controller/Other/Sound/GetSingle');
...
router.post('/add-sound-data', AddSoundMulter, Add);
router.get('/get-sound-data', Get);
router.get('/get-single-sound-data/:id', GetSingleData);
router.put('/update-sound-data/:id', AddSoundMulter, Update);
router.delete('/delete-sound-data/:id', Delete);
