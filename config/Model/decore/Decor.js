...
const LightningSchema = new mongoose.Schema({
    name: {type: String, required: true},
    cost: {type: String, required: true},
    lightningImageName: {type: String, required: true},
    lightningImagePath: {type: String, required: true},
...
const StageDimention = mongoose.model("StageDimention", StageDimentionSchema);
